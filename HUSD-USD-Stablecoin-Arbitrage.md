...
Huobi temporarily offered zero fees in the HUSD market, so this script was created to capture the opportunity.
It uses the tendency of the pair to revert to 1 for stable arbitrage.
...
|----|----|----|
|MAX_ATR|0.0001|Maximum average range|
|ORDER_AMOUNT|1000|Order size per trade|
|PRICE_CEIL|false|Resistance level (price ceiling)|
|PRICE_FLOOR|false|Support level|
|FEE_RATE|false|Fee rate|
|PROFIT_RATE|1e-05|Profit rate|
|PRICE_PRECISION|4|Price precision|
|AMOUNT_PRECISION|4|Order amount precision|
|MIN_ORDER_AMOUNT|true|Minimum order size|

|Button|Default|Description|
|----|----|----|
|profitRate|1e-05|Profit rate|
|orderAmount|1000|Order size per trade|
|Start|__button__|Start|
|Pause|__button__|Pause|
|priceCeil|false|Resistance level (price ceiling)|
|priceFloor|false|Support level|
|maxATR|0.0001|Maximum average range|
