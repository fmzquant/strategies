...
Important notice: this strategy is provided for learning purposes only. Using it in live trading will very likely result in liquidation.

This is a simple martingale strategy. The basic idea is to increase position size after a loss until the accumulated profit reaches the target return.

Because it was written for backtesting, all orders are market orders. It has not been tested in live trading.
> Source (javascript)
