...
Bithumb-OrdersDetail-Interface-Wrapper
...
At the request of some users, this wrapper adds support for querying order information by ID when using Bithumb.
It encapsulates the exchange API endpoint: https://api.bithumb.com/info/order_detail
Only fully filled orders can be queried; orders in other states cannot be retrieved.
