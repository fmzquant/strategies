...
1.4 --- Added an alert-period setting
1.3 --- Added WeChat notifications
1.2 --- Added futures-platform support
1.1 --- Stable version
...
|----|----|----|
|CType0|0|Exchange 0 quote-currency type: CNY | USD|
|ContractType0|0|Exchange 0 contract type: This Week | Next Week | This Month | Quarter|
|MLevel0|0|Exchange 0 leverage: 10x | 20x|
|ContractType1|0|Exchange 1 contract type: This Week | Next Week | This Month | Quarter|
|MLevel1|0|Exchange 1 leverage: 10x | 20x|
|LoopInterval|5000|Polling interval (milliseconds)|
|MaxVal|105|Upper threshold|
|MinVal|102|Lower threshold|
|AlarmPeriod|20|Alert period (in polling intervals)|
|CType1|0|Exchange 1 quote-currency type: CNY | USD|
|Interval|1000|Function retry interval|
|Price0|0|Exchange 0 price type: Asks[0] | Last | Bids[0]|
|Price1|0|Exchange 1 price type: Asks[0] | Last | Bids[0]|
|Option|0|Comparison type: Sub | Dev|

|Button|Default|Description|
|----|----|----|
|TogglePush|__button__|WeChat push notification|
