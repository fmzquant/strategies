'''
策略出处: https://www.fmz.com/strategy/101399
策略名称: CoinPark交易所通用协议 6.27 16:00 更新 关闭了SSL验证
策略作者: botvsing
策略描述:

## CoinPark通用协议Python2版本
用途：可以使BotVs支持coinpark.cc交易所
不知道什么是通用协议？https://www.botvs.com/bbs-topic/1052
可以把通用协议当成普通机器人，运行在BotVs模拟盘即可，不收取费用
也可以把代码保存起来，在服务器上用python运行
运行地址 
