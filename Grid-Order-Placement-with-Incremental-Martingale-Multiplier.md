...
Grid-Order-Placement-with-Incremental-Martingale-Multiplier
...
|----|----|----|
|baseSpacing|10|Add-position spacing|
|baseAmount|0.01|Base order size|
|ratio|1.1|Position growth multiplier|
|interval|500|Polling interval|
|symbol|swap|Contract code|
|profitTarget|10|Target profit spread|
|MarginLevel|50|Leverage setting|
