...
Ported-OKCoin-LeeksReaper-Annotated-Python-Version
...
|MinStock|0.1|Minimum Trade Size|
|CalcNetInterval|60|Net Value Calculation Interval (Seconds)|
|BalanceTimeout|10000|Balance Wait Timeout (Milliseconds)|
|TickInterval|280|Polling Interval (Milliseconds)|
