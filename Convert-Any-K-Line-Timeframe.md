...
Example strategy
- Convert base candlesticks into any target timeframe
- Second-level timeframes are not supported yet

This is a test version. If you find any bugs or issues, please leave a message.
> Strategy Arguments
...
|----|----|----|
|UI_NewCycleForMS|1000*60*60*2|Synthetic timeframe in milliseconds|
