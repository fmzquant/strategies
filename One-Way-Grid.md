...
During testing, enter a starting price to verify that the strategy is working properly.
If no starting price is provided, the strategy buys at the current price and continues buying at each price interval.
WeChat: 173970984
> Strategy Arguments
|Argument|Default|Description|
|----|----|----|
|buyjingdu|2|Order price precision|
|buymount|3|Order quantity precision|
|buypersent|true|Order percentage|
|buylimit|0.01|Minimum order size|
|reffertime|3000|Refresh interval|
|moneybt|100|Grid price spacing|
