...
Test code for opening and closing options positions, placing and canceling orders, and retrieving market data.
The strategy uses the Deribit test environment. For live trading, you can delete the line `exchange.IO("base", "https://test.deribit.com")`.
