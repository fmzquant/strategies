...
A planned buy order executes after the price rises above or falls below a specified level. If you use a market order, you only need to set the purchase amount. If you use a limit order, you also need to specify the limit price and quantity.
...
|BuyAmount|3|Limit order - buy quantity|
|LoopInterval|200|Check interval (milliseconds)|
|MinStock|0.01|Minimum trade quantity|
