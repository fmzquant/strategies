...
OKX&Binance Websocket高频交易模板 (多品种)||OKEX & Binance Websocket High-Frequency Multi-Symbols Trading Template
...
|参数|默认值|描述|
|----|----|----|
|AccessKey|$$$__enc__$$$|OKX_AccessKey|
|Passphrase|$$$__enc__$$$|OKX_Passphrase|
|Debug|false|Debug|
|UseMargin|true|UseMargin|
