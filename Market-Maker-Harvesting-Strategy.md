...
Market-Maker-Harvesting-Strategy
...
|----|----|----|
|a|0.002|Minimum order size per trade, in BTC|
|k|11|Risk coefficient k; recommended range 10-50. The smaller the value, the higher the risk and the greater the potential return|
|g2|100|Leverage multiplier|
|xx|false|This is a counter|
|pc|50|Close-position threshold|
