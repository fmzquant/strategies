...
Cryptocurrency-Futures-Multi-Asset-ATR-Strategy-Tutorial
...
Related article: https://www.fmz.com/digest-topic/8726

This strategy was ported from a simple M-Language strategy:
```
...
For multi-asset usage, the parameters are designed as a JSON string:
```
var params = '[{
        "symbol" : "swap",
        "period" : 86400,
...
This strategy uses a template library: Cryptocurrency Futures Trading Library (Beta).
...
|----|----|----|
|params||Parameters|
|onlyOne|true|Run only a single instrument|
|symbol|swap|Futures contract code|
|period|86400|Candlestick period in seconds|
|stopLoss|0.07|Stop-loss|
|atrPeriod|10|ATR period|
|emaPeriod|10|EMA period|
|trackRatio|true|Channel coefficient|
|openRatio|0.1|Entry ratio|
