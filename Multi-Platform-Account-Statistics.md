...
|----|----|----|
|Interval|20|Check interval (seconds)|
|Type|0|Display type: total assets|net assets|total cash|total coin amount|
|coverStocks|false|Covered-position total coin amount|
