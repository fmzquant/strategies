...
Depth-Market-Making-Order-Book-Control-Trading-Robot-Market-Making-Tool
...
A strategy designed to run on an exchange. In general, it gets the current price while placing buy and sell orders to add depth, and it can mirror other market quotes or reference other market trends.
