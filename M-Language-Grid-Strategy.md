...
|----|----|----|
|ktkc|10|Initial short position|
|dtkc|false|Initial long position|
|y|0.02|Profit-based reduction distance|
|s|0.02|Loss-based add-position distance|
|jia|true|Loss-based add-position size|
|jian|true|Profit-based reduction size|
