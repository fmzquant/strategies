...
A basic implementation of a grid trading strategy.

This is not currently the author’s optimal version. The version being used in practice is a Binance WebSocket edition.
If there is enough interest, that Binance WebSocket version can be adapted into a version suitable for running on FMZ.
...
|lower_price|false|Lower Price Bound|
|upper_price|false|Upper Price Bound|
|grid_num|2|Number of Grids|
|trading_per_grid|false|Buy Amount per Grid|
|price_precision|2|Order Price Precision|
|amount_precision|5|Order Amount Precision|
