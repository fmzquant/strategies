...
OKEX-V5-K-Line-Data-Paginated-Query-Example-Python-Version
...
## OKEX V5 K-Line Data Paginated Query Example

Because the OKEX V5 interface returns at most 100 bars per request, pagination is required. This example shows how to query the K-line interface page by page to obtain 1,440 bars of data.
...
The ```main``` function is a usage example. The other functions can be copied out and used directly.
