...
Spot-Trailing-Take-Profit-Strategy
...
After the strategy starts, it continuously tracks the highest price. If price falls back from that high by a specified ratio, it takes profit. For example, if the latest high is 100 and the take-profit ratio is 0.98, the strategy closes the position when price falls to 98.
...
|Amount|0.1|Take-Profit Amount|
|Advance|false|Show More Parameters|
|Intervel|5000|Sleep Interval (ms)|
|Log_profit|600000|Profit Log Interval (ms)|
