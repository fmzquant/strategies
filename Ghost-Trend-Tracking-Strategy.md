...
|tickInterval|3000|Polling interval (milliseconds)|
|orderValue|50|Order value (%)|
|bfCount|168|Number of nodes|
|isFlag|false|Reversal signal|
|stopSurplus|3|Percentage-based position reduction|
|stopSurplusCount|50|Reduce position by (%)|
...
|----|----|----|
|Close All Positions|__button__|Close All Positions|
|Spot-to-Futures|10|Transfer USDT from spot account to futures account|
|Futures-to-Spot|10|Transfer USDT from futures account to spot account|
